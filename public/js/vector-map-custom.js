        ...
        $('#legend-map').vectorMap({
            ...
            series: {
                markers: [{
                    ...
                    attribute: 'image',
                    scale: {
                        bank: 'static/assets/images/vectormap/icon-bank.png',
                        factory: 'static/assets/images/vectormap/icon-factory.png'
                    },
                    values: {
                        '4': 'bank',
                        '5': 'factory'
                ...
                regions: [{
                    ...
                    scale: {
                        redGreen: 'static/assets/images/vectormap/bg-red-green.png',
                        yellowBlue: 'static/assets/images/vectormap/bg-yellow-blue.png'
                    },
                    values: {
                        "US-TX": 'redGreen',
                        "US-CA": 'yellowBlue'
        ...
        $('#icon-map').vectorMap({
            ...
            series: {
                markers: [{
                    attribute: 'image',
                    scale: {
                        'closed': 'static/assets/images/vectormap/icon-np-3.png',
                        'activeUntil2018': 'static/assets/images/vectormap/icon-np-2.png',
                        'activeUntil2022': 'static/assets/images/vectormap/icon-np-1.png'
                    },
